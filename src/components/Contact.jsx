      ...
      <div className="  rounded py-10 bg-sky-50">
        ...
        <div className="flex md:justify-between  md:flex-row flex-col items-center ">
          ...
          <div className=" md:w-[45%] h-mix-[52vh] rounded   w-[85%] ">
            ...
            >
              <div className="flex justify-center border-none flex-col md:flex-row gap-5">
                <Input
                  type="text"
                  placeholder="Frist Name"
                  className=" outline-none w-60 border-none md:w-[40%] h-12 p-4 rounded"
                />
                <Input
                  type="text"
                  placeholder="Last Name"
                  className="w-60 border-none outline-none md:w-[40%] h-12 p-4 rounded"
                />
              </div>
              <Input
                type="text"
                placeholder="Email"
                className=" outline-none w-60 border-none md:w-[80%] md:h-12    p-4 rounded "
              />
              <Textarea
                placeholder="Massage...."
                className=" outline-none w-60 border-none md:w-[80%] md:h-30   text-start rounded "
              />
